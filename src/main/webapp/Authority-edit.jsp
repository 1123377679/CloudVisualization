...
<div class="layui-fluid">
    <div class="layui-row">
        <%-- items：要循环的集合--%>
        <%-- requestScope.pageUtils.records:从request中取值--%>
        <%-- var:循环变量--%>
<%--        <c:forEach items="${requestScope.userById}" var="u">--%>
        <form class="layui-form" target="_parent" action="/AuthorityServlet.do?action=update&id=${requestScope.userById.id}" method="post">
